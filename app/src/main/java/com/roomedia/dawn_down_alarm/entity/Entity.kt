...
@Entity(primaryKeys = ["keyword", "packageName"],
    foreignKeys = [ForeignKey(onDelete = ForeignKey.CASCADE, entity = App::class, parentColumns = ["packageName"], childColumns = ["packageName"])],
...
class AppAndKeywords {
    ...
    operator fun component2(): Set<Keyword> {
        return keywords
    }
}